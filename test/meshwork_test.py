...
def test_meshwork_creation(basic_meshwork):
    ...
    nrn.add_annotations(
        "syn_in_100", syn_in_df, point_column="ctr_pt_position", max_distance=50
    )
...
def test_meshwork_masking(basic_meshwork):
    ...
    mask = mesh_filters.filter_geodesic_distance(nrn.mesh, [287636, 203013], 5000)
    nrn.apply_mask(mask)
